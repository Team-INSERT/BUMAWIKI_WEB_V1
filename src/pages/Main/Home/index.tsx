		...
		<>
			...
			<S.HomeWrap>
				<C.Board>
					...
					<S.TitleBoxWrap>
						<S.TitleBoxMainWrap>
							<S.TitleBoxMainTitle>부산소프트웨어마이스터고등학교</S.TitleBoxMainTitle>
							<S.TitleBoxMainEngTitle>Busan Software Meister High School</S.TitleBoxMainEngTitle>
						</S.TitleBoxMainWrap>
						...
						<S.TableWrap>
							...
							<S.TableContent>
								<S.TableText>소나무 - 장수(長壽), 꿋꿋한 절개와 의지를 보이다.</S.TableText>
							</S.TableContent>
						</S.TableWrap>
						<S.TableWrap>
							<S.TableName>
						...
						<S.TableWrap>
							...
							<S.TableContent>
								<S.TableText>솔개 - 유연하고 민첩하며 늠름한 기상으로 높이 날아 세계를 보다.</S.TableText>
							</S.TableContent>
						</S.TableWrap>
						<S.TableWrap>
							<S.TableName>
						...
						<S.TableWrap>
							...
							<S.TableContent>
								<S.TableText>부산광역시 강서구 가락대로 1393 (가락동)</S.TableText>
							</S.TableContent>
						</S.TableWrap>
						<S.TableWrap>
							<S.TableName>
							...
							<S.TableContent>
								<S.TableLink href="https://school.busanedu.net/bssm-h/main.do" target={'_blank'} rel={'noreferrer'}>
									https://bssm.hs.kr
								</S.TableLink>
							</S.TableContent>
						</S.TableWrap>
							...
							<S.HistoryContent>
								<S.TitleBoxWrap>
									...
									<S.TableWrap>
										...
										<S.TableContent>
											<S.TableText>부산소프트웨어마이스터고등학교 개교</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
									...
									<S.TableWrap>
										...
										<S.TableContent>
											<S.TableText>제48회 졸업식(57명), 졸업생 총 9,800명</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
									...
									<S.TableWrap>
										...
										<S.TableContent>
											<S.TableText>학교평가 최우수학교 선정(교육과학기술부장관상)</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
										...
										<S.TableContent>
											<S.TableText>부산광역시교육청 우수특성화고로 선정</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
									...
									<S.TableWrap>
										...
										<S.TableContent>
											<S.TableText>실험실습 최우수 학교로 교육감상 수상</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
									...
									<S.TableWrap>
										...
										<S.TableContent>
											<S.TableText>부산서여자상업고등학교로 교명 변경</S.TableText>
										</S.TableContent>
									</S.TableWrap>
									<S.TableWrap>
										<S.TableName>
					...
					<S.BusWrap>
						<C.AccodianMenu name={'운행 버스'}>
							...
							<S.BusDescription>
								<S.TitleBoxWrap>
									<S.TableWrap style={{ marginTop: '-4px', borderTop: '2px solid #ccc' }}>
										<S.TableContent>
											<S.TableText>부산산업과학고교 / 부산소프트웨어마이스터고교</S.TableText>
										</S.TableContent>
										<S.TableName>
									...
									<S.TableWrap style={{ marginTop: '-4px', marginBottom: '80px' }}>
										<S.TableContent>
