    ...
    return (
        <div>
            {detail ?
                ...
                :
                (<>
                    <div className='title-line-wrap opacity' onClick={onClickDetail} >
                        <svg width="40" height="40" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22.7249 43.2249C22.9562 43.4567 23.231 43.6406 23.5334 43.766C23.8358 43.8915 24.16 43.9561 24.4874 43.9561C24.8149 43.9561 25.1391 43.8915 25.4415 43.766C25.7439 43.6406 26.0187 43.4567 26.2499 43.2249L37.7249 31.7499C37.9567 31.5187 38.1406 31.2439 38.266 30.9415C38.3915 30.6391 38.4561 30.3149 38.4561 29.9874C38.4561 29.66 38.3915 29.3358 38.266 29.0334C38.1406 28.7309 37.9567 28.4562 37.7249 28.2249L26.2499 16.7499C26.0185 16.5185 25.7437 16.3349 25.4413 16.2096C25.1389 16.0844 24.8148 16.0199 24.4874 16.0199C24.1601 16.0199 23.836 16.0844 23.5336 16.2096C23.2312 16.3349 22.9564 16.5185 22.7249 16.7499C22.4935 16.9814 22.3099 17.2562 22.1846 17.5586C22.0594 17.861 21.9949 18.1851 21.9949 18.5124C21.9949 18.8398 22.0594 19.1639 22.1846 19.4663C22.3099 19.7687 22.4935 20.0435 22.7249 20.2749L32.4249 29.9999L22.7249 39.6999C21.7749 40.6749 21.7749 42.2749 22.7249 43.2249Z" fill="#818181" />
                        </svg>
                        <span className='title-line-name'>{name}</span>
                    </div>
                    <div className='line' style={{ width: '100%' }} />
